...
export const dashboardPages: DashboardPage[] = [
  {
    ...
    description: "Synthèse globale du runtime, des sessions, des relances et de la posture d'orchestration.",
  ...
  },
  {
    ...
    description: "Pilotage du profil actif, disponibilité de la passerelle Claude et lecture rapide de la posture runtime.",
  ...
  },
  {
    ...
    description: "État des limites de débit, crédits amont et charge utile brute exposée par le runtime.",
  ...
  },
  {
    ...
    description: "Visibilité sur les backoffs en cours, les prochaines fenêtres de reprise et les erreurs récentes.",
...
export function dashboardPageForPath(pathname: string) {
  ...
  return dashboardPages.find((page) => page.path === normalizedPath) ?? dashboardPages[0]
}
